...
namespace SubstituirMetodoPorObjetoMetodo
{
    class Program
    {
    ...
    class Produto
    {
        ...
        {
            return new CalculadoraPrecoProduto(this, precoBase, acrescimo, desconto).Calcular();
        }
    ...
    class CalculadoraPrecoProduto
    {
        ...
        public CalculadoraPrecoProduto(Produto produto, decimal precoBase, decimal acrescimo, decimal desconto)
        {
